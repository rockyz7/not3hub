...
const BlankNote = () => {
  ...
  const { body, title, onChange, formState, date, updatedDate } =
    useForm(activeNote);
  ...
  return (
    <>
      <div className="w-full flex flex-row-reverse justify-between p-2 items-center z-10">
      ...
      <div className={`rounded-xl  shadow-gray-900 mt-2 `}>
        <TextField
          type="text"
          variant="filled"
          fullWidth
